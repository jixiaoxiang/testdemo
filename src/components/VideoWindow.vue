...
// 窗口
.window-trans-enter-active,
.window-trans-leave-active {
  transition: all 0.3s ease-out;
  opacity: 1;
}

.window-trans-enter,
.window-trans-leave-to {
  opacity: 0;
}

.window-trans-enter-to,
.window-trans-leave {
  opacity: 1;
}
...
.content-trans-enter,
.content-trans-leave-to {
  transform: translateY(-10%);
  opacity: 0;
}

.content-trans-enter-to,
.content-trans-leave {
  transform: translateY(0%);
  opacity: 1;
}
